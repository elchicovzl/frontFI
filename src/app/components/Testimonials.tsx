...
. <span className="font-serif">&rdquo;</span></p>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-gray-50 sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <p className="text-gray-600"> <span className="font-serif">&ldquo;</span> Estamos muy agradecidos con Frontera Inmobiliaria. Hemos podido recrear un nuevo logro familiar. Es gratificante continuar creciendo como familia y agradecemos a esta empresa por ayudarnos a escoger nuestro espacio.
 <span className="font-serif">&rdquo;</span></p>
                        <div>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-gray-50 sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                        <p className="text-gray-600"> <span className="font-serif">&ldquo;</span> Muy agradecida con Frontera Inmobiliaria. Estuvieron siempre presentes en mi proceso, de principio a fin, no fue fácil porque vengo de otra ciudad, pero quedó con una gratitud infinita por la labor que ejercen y prestan como empresa. Super recomendados. <span className="font-serif">&rdquo;</span></p>
                        <div>
